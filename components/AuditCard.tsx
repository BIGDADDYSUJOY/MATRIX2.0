...
/**
 * AuditCard: Memoized component for supply chain node display.
 *
 * OPTIMIZATION:
 * Wrapped in React.memo to prevent unnecessary re-renders when other nodes
 * or parent state (like wave dynamics) update.
 */
const AuditCard: React.FC<AuditCardProps> = React.memo(({ agent, onClick, status }) => {
  const statusColors = {
